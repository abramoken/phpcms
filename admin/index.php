...
<?php 
// if($connection) echo "<h1>connection</h1>";
 ?>
        <!-- Navigation -->
...
for($i = 0; $i < 8; $i++){
    echo "['{$element_text[$i]}'" . "," . "{$element_count[$i]}],";
        ...
        ?>
            ...
            var chart = new google.charts.Bar(document.getElementById('colomnchart_material'));
            chart.draw(data, options);
        }
    </script>

<div id="colomnchart_material" style="width: 'auto'; height: 500px; "></div>
